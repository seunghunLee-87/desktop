...
export function handleMentionNotification(event: IpcMainEvent, title: string, body: string, channel: {id: string}, teamId: string, url: string, silent: boolean, data: MentionData, postUserId: string) {
    displayMention(title, body, channel, teamId, url, silent, event.sender, data, postUserId);
}
